...
<div class="wrap_table" >
	<table class="table_detail">
		...
		<tr>
			...
			<td colspan="3">
				<textarea id="description" name="description" cols="100" rows="20" style="width:90%;"></textarea>
			</td>
		</tr>
		</thead>
		<tbody>
...
//목록으로
function GoList(){
	var url = "${pageContext.request.contextPath}/admin/DISC_BMB_00/default";
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/DISC_BMB_00/default', null, '${TMENUID}', '${SMENUID}', '${METYPE}');
};
