...
<div style="margin-top: 20px; margin-bottom: 60px;">
	...
	<div style="padding:10px; margin:10px;">
		...
		<span style="margin-left: 60px;">관리자명</span><input type="text" class="input_text" id="admin_nm" name="admin_nm" style="width: 70px;" maxlength="20" />
		<span>e-mail</span><input type="text" class="input_text" id="email" name="email" style="width: 220px;" maxlength="40" />
		<a class="btn_s_wh" id="btn_direct_reg" onclick="RegAdmin1()">등록</a>
	</div>
	 -->
	<hr style="display: block;" color="#233D73" size="1px">
</div>
...
<script>
function PageReload(){
	var url = "${pageContext.request.contextPath}/admin/ETHI_ADM_00/default";
...
function RegAdmin1(){
	...
	GetAjaxXml('${pageContext.request.contextPath}/admin/ETHI_ADM_00/RegAdmin1', $("#frmPage").serialize(), success_function);
}
...
function RegAdmin2(){
	...
	GetAjaxXml('${pageContext.request.contextPath}/admin/ETHI_ADM_00/RegAdmin2', data, success_function);
}

success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/ETHI_ADM_00/default', null ,'${TMENUID}', '${SMENUID}', '${METYPE}');
};
...
function DelAdmin(admin_id){
	...
	GetAjaxXml('${pageContext.request.contextPath}/admin/ETHI_ADM_00/DelAdmin', {admin_id:admin_id, reg_id:$("#user_id").val()}, success_function);
}
</script>
