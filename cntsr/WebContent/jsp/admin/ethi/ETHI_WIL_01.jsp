...
<div class="wrap_table" >
	...
	<tr>
		...
		<td>
			<span>
				<input type="text" class="input_text" id="sdate" name="sdate" style="width:70px;" value="${SDATE}" readonly/>
			</span>
		</td>
	</tr>
	<tr>
...
$('#attach_file').change(function() {
	$("#fileYn").val("Y");
	if($("#attach_file").val() != ""){
		GetAjaxXmlMultiPart("frmPage", "${pageContext.request.contextPath}/admin/ETHI_RUL_01/RegAttachFile", null, file_success_function, true, null, 'attach_file', 'gif, ppt, pptx, xsl, xlsx, doc, docx, pdf, hwp, jpg, png, mp3, mp4, avi', true);
	}
});
//첨부파일 등록 성공시
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/ETHI_WIL_00/default', null ,'${TMENUID}', '${SMENUID}', '${METYPE}');
};
