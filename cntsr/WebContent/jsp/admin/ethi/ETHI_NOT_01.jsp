<%--
  - Author      : 김현우
  - Date        : 2014-07-08
  - Description : 윤리경영 > 반부패청렴 > 사규 제/재개정 예고제 > 상세
...
function GoList(){
	var url = "${pageContext.request.contextPath}/admin/ETHI_NOT_00/default";
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/ETHI_NOT_00/default', null ,'${TMENUID}', '${SMENUID}', '${METYPE}');
};
