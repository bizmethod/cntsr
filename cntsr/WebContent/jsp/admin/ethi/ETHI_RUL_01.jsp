<%--
  - Author      : 김현우
  - Date        : 2014-07-08
  - Description : 윤리경영 > 반부패청렴 > 정관 및 사규 > 상세
...
$('#attach_file').change(function() {
	$("#fileYn").val("Y");
	if($("#attach_file").val() != ""){
		GetAjaxXmlMultiPart("frmPage", "${pageContext.request.contextPath}/admin/ETHI_RUL_01/RegAttachFile", null, file_success_function, true, null, 'attach_file', 'gif, ppt, pptx, xsl, xlsx, doc, docx, pdf, hwp, jpg, png, mp3, mp4, zip, zip, avi', true);
	}
});
//첨부파일 등록 성공시
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/ETHI_RUL_00/default', null ,'${TMENUID}', '${SMENUID}', '${METYPE}');
};
