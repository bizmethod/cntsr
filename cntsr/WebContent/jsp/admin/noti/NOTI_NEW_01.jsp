...
<div class="wrap_table" >
	<table class="table_detail">
		...
		<tr>
			...
			<td colspan="3">
				<span>
				<input type="radio" name="noti_typ" value="NO" id="noti1" <c:if test="${map.get('NOTI_TYP') == 'NO' || sel_typ == 'NO' || sel_typ == ''}">checked="checked"</c:if>> <label for="noti1"> 공지사항</label></input>
				<input type="radio" name="noti_typ" value="NU" id="noti2" <c:if test="${map.get('NOTI_TYP') == 'NU' || sel_typ == 'NU'}">checked="checked"</c:if>> <label for="noti2"> 뉴스</label></input>
				</span>
			</td>
		</tr>
		<tr>
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/NOTI_NEW_00/default', null, '${TMENUID}', '${SMENUID}', '${METYPE}');
};
