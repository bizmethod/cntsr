...
<script>
function PageReload(){
	var url = "${pageContext.request.contextPath}/admin/INTR_ADM_00/default";
...
function RegAdmin1(){
	...
	GetAjaxXml('${pageContext.request.contextPath}/admin/INTR_ADM_00/RegAdmin1', $("#frmPage").serialize(), success_function);
}
...
function RegAdmin2(){
	...
	GetAjaxXml('${pageContext.request.contextPath}/admin/INTR_ADM_00/RegAdmin2', data, success_function);
}

success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/INTR_ADM_00/default', null ,'${TMENUID}', '${SMENUID}', '${METYPE}');
};
...
function DelAdmin(admin_id){
	...
	GetAjaxXml('${pageContext.request.contextPath}/admin/INTR_ADM_00/DelAdmin', {admin_id:admin_id, reg_id:$("#user_id").val()}, success_function);
}
</script>
