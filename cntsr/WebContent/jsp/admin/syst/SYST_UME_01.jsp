...
<div class="wrap_table" >
	...
	<div class="wrap_tab" >
		...
		<col style="width:14%" />
			...
			<tr>
				<td colspan="7" align="center" >등록된 2depth 메뉴가 없습니다.</td>
			</tr>
			</c:if>
...
function add2depthMenu() {
	GetAjaxXml('${pageContext.request.contextPath}/admin/SYST_UME_01/add2depthMenu', $("#frm").serialize(), PageReload);
}

function upd2depthMenu() {
	GetAjaxXml('${pageContext.request.contextPath}/admin/SYST_UME_01/upd2depthMenu', $("#frm").serialize(), PageReload);
}

function del2depthMenu() {
	GetAjaxXml('${pageContext.request.contextPath}/admin/SYST_UME_01/del2depthMenu', {menu_id:$("#menu_id").val()}, PageReload);
}
</script>
