...
<div class="top_area">
	<ul>
		...
		<li class="ml10"><a href="${pageContext.request.contextPath}/VIEWER/getExcelDown/COMM_01_02/CA" class="btn_s_wh_130" id="btn_excel" >공공누리 엑셀저장</a></li>
	</ul>
</div>
	<table class="table_list">
		...
		<tr>
			<td colspan="6" align="center" >등록된 사회공헌 목록이 없습니다.</td>
		</tr>
		</c:if>
...
<script>
function PageReload(){
	var url = "${pageContext.request.contextPath}/admin/COMM_SOC_00/default";
...
function goDetail(seq,IU){
	...
	var url = "${pageContext.request.contextPath}/admin/COMM_SOC_01/default";
...
// 			noti_typ : 'CA',
// 	};
// 	GoPage("${pageContext.request.contextPath}/admin/COMM_SOC_00/getExcelDown", data, '${TMENUID}', '${SMENUID}', '${METYPE}');
// }
</script>
