...
<div class="top_area">
	...
	<li class="ml10">
			<select name="sel_appr" id="sel_appr" class="sel_basic" onchange="PageReload()">
				<option value="" <c:if test="${sel_appr ==''}" >selected="selected"</c:if>>전체</option>
	...
	<table class="table_list">
		...
		<tr>
			<td colspan="6" align="center" >등록된 고객의소리가 없습니다.</td>
		</tr>
		</c:if>
...
function goDetail(seq){
	...
	var url = "${pageContext.request.contextPath}/admin/COMM_VOI_01/default";
