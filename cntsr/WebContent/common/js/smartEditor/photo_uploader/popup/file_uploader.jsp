...
<%@page import="mcommercelab.cntsr.common.CommonProperties"%>
<%@page import="mcommercelab.cntsr.common.DateUtils"%>
<%@page import="com.oreilly.servlet.MultipartRequest"%>
<%@ page contentType="text/html; charset=UTF-8" %>

<%

String STIME = DateUtils.getTimeStamp(7);

File dir = new File(CommonProperties.getConfigProperty("file.upload_path")+"/img/pic/"+STIME+"/");
	if(!dir.exists()){
		dir.mkdirs();
	}

String path = CommonProperties.getConfigProperty("file.upload_path")+"/img/pic/"+STIME; // 이미지가 저장될 주소
String filename = "";
	...
	try {
		...
		if (!upfile.equals("")) {
			...
			<form id="fileform" name="fileform" method="post">
				<input type="hidden" name="filename" value="<%=STIME%>/<%=filename%>">
