...
<div class="wrap_table" >
	<table class="table_detail">
		...
		<tr>
			<th class="th_first">사회공헌활동<br/>실시일</th>
			<td>
				<span>
					<input type="text" class="input_cal" name="start_d" id="start_d" value="${map.START_D}" />
				</span>
			</td>
		</tr>
		<tr>
						...
						<c:forEach var="list" items="${attachList}">
							...
							<li class="attach_li">
								<a href="${pageContext.request.contextPath}/VIEWER/file/${list.SEQ_FILE}">
									...
									<input type="hidden" name="fileMetaData" value="${list.FILE_DIR}|${list.FILE_SIZE}|${list.ORG_FILE_NM}|0" />
								</a>
							</li>
							</div>
						</c:forEach>
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/COMM_SOC_00/default', null, '${TMENUID}', '${SMENUID}', '${METYPE}');
};
