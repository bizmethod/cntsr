...
<div class="top_area">
	<ul>
		...
		<li class="ml10"><a href="${pageContext.request.contextPath}/VIEWER/getExcelDown/ETHI_01_03/EK" class="btn_s_wh_130" id="btn_excel" >공공누리 엑셀저장</a></li>
	</ul>
</div>
...
<script>
	function PageReload(){
		var url = "${pageContext.request.contextPath}/admin/ETHI_INT_00/default";
	...
	function goDetail(seq,IU){
		...
		var url = "${pageContext.request.contextPath}/admin/ETHI_INT_01/default";
