<%--
  - Author      : 김현우
  - Date        : 2014-07-08
  - Description : 윤리경영 > 반부패청렴 > 내부 감사결과 > 상세
...
<div class="wrap_table" >
	...
	<tr>
		<th class="th_first">생성일자</th>
		<td>
			<span>
				<input type="text" class="input_cal" id="create_dt" name="create_dt" style="width:100px;" value="${map.CREATE_DT}" maxlength="25" readonly="readonly"/>
			</span>
		</td>
	</tr>
	<tr>
		<th class="th_first">결과통보일</th>
		<td>
			<span>
				<input type="text" class="input_cal" id="noti_dt" name="noti_dt" style="width:100px;" value="${map.NOTI_DT}" maxlength="25" readonly="readonly"/>
			</span>
		</td>
	</tr>
	<tr>
...
function GoList(){
	var url = "${pageContext.request.contextPath}/admin/ETHI_INS_00/default";
...
success_function = function(){
	GoPage('${pageContext.request.contextPath}/admin/ETHI_INS_00/default', null ,'${TMENUID}', '${SMENUID}', '${METYPE}');
};
