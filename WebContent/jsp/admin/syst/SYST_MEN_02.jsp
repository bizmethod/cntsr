...
<div style="position: relative; float: right; margin-bottom: 15px;">
	...
	<div class="wrap_tab" >
		...
		<col style="width:14%" />
			...
			<tr>
				<td colspan="6" align="center" >등록된 3depth 메뉴가 없습니다.</td>
			</tr>
			</c:if>
...
function add3depthMenu() {
	GetAjaxXml('${pageContext.request.contextPath}/admin/SYST_MEN_02/add3depthMenu', $("#frm").serialize(), PageReload);
}

function upd3depthMenu() {
	GetAjaxXml('${pageContext.request.contextPath}/admin/SYST_MEN_02/upd3depthMenu', $("#frm").serialize(), PageReload);
}

function del3depthMenu() {
	GetAjaxXml('${pageContext.request.contextPath}/admin/SYST_MEN_02/del3depthMenu', {menu_id:$("#menu_id").val()}, PageReload);
}
</script>
