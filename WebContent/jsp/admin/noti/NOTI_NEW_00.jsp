...
<div class="top_area">
	<ul>
		<li class="ml10">
			<select name="sel_typ" id="sel_typ" class="sel_basic" onchange="PageReload()">
				...
				<option value="NO" <c:if test="${sel_typ =='NO'}" >selected="selected"</c:if>>공지사항</option>
				<option value="NU" <c:if test="${sel_typ =='NU'}" >selected="selected"</c:if>>뉴스</option>
			</select>
		</li>
		<li class="ml10">
		...
		<li class="ml10"><a href="${pageContext.request.contextPath}/VIEWER/getExcelDown/NOTI_01/NO" class="btn_s_wh_130" id="btn_excel" >공공누리 엑셀저장</a></li>
	</ul>
</div>
	<table class="table_list">
		...
		<tr>
			<td colspan="6" align="center" >등록된 GKL소식이 없습니다.</td>
		</tr>
		</c:if>
...
function goDetail(seq,IU){
	...
	var url = "${pageContext.request.contextPath}/admin/NOTI_NEW_01/default";
