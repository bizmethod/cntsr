...
<script>
function PageReload(){
	var url = "${pageContext.request.contextPath}/admin/DISC_FIN_00/default";
...
var success_function = function(xmlData) {
	GoPage("${pageContext.request.contextPath}/admin/DISC_FIN_00/default", null, '${TMENUID}', '${SMENUID}', '${METYPE}');
};

function goDetail(seq,IU){
	
	var url = "${pageContext.request.contextPath}/admin/DISC_FIN_01/default";
